 ...
 * generated in the com.barrett.base.webservices.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetWeatherByCityname_QNAME = new QName("http://server.webservices.base.barrett.com/", "getWeatherByCityname");
    private final static QName _GetWeatherByCitynameResponse_QNAME = new QName("http://server.webservices.base.barrett.com/", "getWeatherByCitynameResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.barrett.base.webservices.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.webservices.base.barrett.com/", name = "getWeatherByCityname")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.webservices.base.barrett.com/", name = "getWeatherByCitynameResponse")
