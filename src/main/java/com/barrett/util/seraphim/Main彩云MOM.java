 ...
 */
public class Main彩云MOM {

    // dao、service、mapper、controller 需要放入的路径
    public final static String urlName = "src/main/java/com/util/seraphim/code";
    // 固定字段
    public static String[] params = {"id", "createdBy", "createdTime", "updateBy", "updateTime", "status"};
    //需要生成的类
    public static Object object = new IVDevicesCollect();
    //表名
    public static String table = IVDevicesCollect.TableName;
...
//        mc.createCtrl();
    ...
    public static void createTbaleSql() {
        SeraphimMapper.fixParam = SeraphimMapper.fixedParams(Main彩云MOM.params);
